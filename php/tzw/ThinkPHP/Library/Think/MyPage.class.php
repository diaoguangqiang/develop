...
class MyPage {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>'个题目','prev'=>'上一页','next'=>'下一页','first'=>'首页','last'=>'尾页','theme'=>' %totalRow% %header% %nowPage%/%totalPage% 页 %upPage% %downPage% %first%  %prePage%  %linkPage%  %nextPage% %end%');
    // 默认分页变量名
    protected $varPage;
        ...
        for($i=1;$i<=$this->rollPage;$i++){
            ...
            if($page!=$this->nowPage){
                ...
                if($this->totalPages != 1){
                    $linkPage .= "<li><a><span class='current'><font color='#FF0000'>".$page."</font></span></a></li>";
                }
            }
        }	
