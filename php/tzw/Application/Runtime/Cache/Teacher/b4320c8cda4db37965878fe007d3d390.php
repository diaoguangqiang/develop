					...
					<div class="panel panel-primary">
						<div class="panel-heading">
							<h3 class="panel-title">
								<span class="badge pull-right"> <!-- <a href="/tzw" > --><?php echo ($num_bank_limit_info); ?><!-- </a>  --> </span><?php echo ($add_info); ?>
							</h3>					
						</div>
						...
						<div class="panel-body">
							<div class="row">
								...
								<div class="col-md-4">
									<h4><?php echo ($bank_name); ?></h4>
									<form  role="form" action="/tzw/teacher.php/Bank/addName" method="post">
										<div class="form-group has-success">
											<input type="text" class="form-control" name="name" id="inputSuccess1" placeholder="<?php echo ($bank_name_input_please); ?>">
											<h6><?php echo ($bank_name_input_tips); ?></h6>
										</div>
										<div class="form-group">
