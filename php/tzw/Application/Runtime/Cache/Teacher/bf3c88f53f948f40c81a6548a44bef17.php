  ...
  <head>
    ...
    <style type="text/css">
    	.img_bg{
		    ...
		    padding:10px;
		    background:#666 url('/tzw/PublicHome/img/tea_bg_1.png') no-repeat;
    	}
    </style>
  </head>
		   ...
		   <div class="container">
				  ...
				  <div class="navbar-header">
					...
					<div class="collapse navbar-collapse" id="mobilemenu">						
						<a  class="navbar-brand"><?php echo ($tea_plat); ?></a>
	...
	<div  class="img_bg templatemo-bg-gray">
		<div class="container ">
			...
			<div class="col-md-4 ">
				...
				<form class="form-horizontal templatemo-container templatemo-login-form-1 margin-bottom-30" role="form" action="/tzw/teacher.php/Index/check" method="post">				
