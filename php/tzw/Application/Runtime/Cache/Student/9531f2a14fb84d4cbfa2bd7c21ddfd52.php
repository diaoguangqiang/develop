	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="/tzw/student.php/Bank/loginout" ><?php echo ($quit); ?></a></li>
			
			</ul>
		
			<ul class="nav navbar-nav navbar-right">
				<li class="active"><a href="#"><?php echo ($mobile_app); ?></a></li>
			</ul>
...
<div class="col-sm-3 col-md-2 sidebar">
		...
		<ul class="nav nav-sidebar">
			<li><a href="/tzw/student.php/Bank/../bank/prePractice"><?php echo ($practice); ?></a></li>
		</ul>
...
<!-- / menu left-->
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">	
			...
			<p>
				<!-- button group -->
				<a class="btn btn-success" href="/tzw/student.php/Bank/choiceDo?pid=<?php echo ($pid); ?>&p=1"> <?php echo ($choice); ?></a>
				<a class="btn btn-default" href="/tzw/student.php/Bank/judgeDo?pid=<?php echo ($pid); ?>&p=1"><?php echo ($judge); ?></a>
				<a class="btn btn-default" href="/tzw/student.php/Bank/subjectDo?pid=<?php echo ($pid); ?>&p=1"><?php echo ($subject); ?></a>
						...
						<div class="panel panel-info">						
							...
							<div class="panel-body">						
									...
									<div class="radio">
									   <label>
									      <input type="radio" name="optionsRadios" id="optionsRadios1" 
									         value="option1" > A.&nbsp;<?php echo ($vo["choicea"]); ?>
									   </label>
									</div>
									<div class="radio">
									   <label>
									      <input type="radio" name="optionsRadios" id="optionsRadios2" 
									         value="option2"> B.&nbsp;<?php echo ($vo["choiceb"]); ?>
									   </label>
									</div>
									<div class="radio">
									   <label>
									      <input type="radio" name="optionsRadios" id="optionsRadios2" 
									         value="option2"> C.&nbsp;<?php echo ($vo["choicec"]); ?>
									   </label>
									</div>
																		
									<?php if($vo["choiced"] == ''): ?><!-- error  -->
										<div class="radio">
											   <label>
											      <input type="radio" name="optionsRadios" id="optionsRadios2" 
											         value="option2"> D.&nbsp;<?php echo ($vo["choiced"]); ?>
											   </label>
										</div>
										<!-- / error  -->
									<?php else: ?>									
								...
								<div class="alert alert-warning" >
									<?php echo ($answer); echo ($vo["choiced"]); ?>
								</div>
								<!-- / answer  -->
