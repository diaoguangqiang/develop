...
<!-- / menu left-->
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<!-- head -->
			<h3 class="page-header"><?php echo ($bank); ?>&nbsp;<i class="service-icon fa fa-angle-right"></i>&nbsp;<?php echo ($practice); ?></h3>
			<!-- / head -->
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--  -->
					<div class="col-md-4">
						...
						<div class="panel-body" align="center" >
							...
							<p><a class="btn btn-success navbar-right" href="/tzw/student.php/Bank/choiceDo?pid=<?php echo ($vo["id"]); ?>&p=1" role="button"><?php echo ($xuexi); ?>&nbsp;&raquo;</a></p>
