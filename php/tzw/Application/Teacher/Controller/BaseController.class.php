...
class BaseController extends Controller{
	...
	private function set_assign(){
		...
		$this->assign('add_info', '完善信息');
		$this->assign('bank_name', '题库名称');
		$this->assign('bank_name_input_please', '请输入题库名称 , (如: 期末英语模拟考试)...');
		$this->assign('num_bank_limit_info', '最大支持10个题库');
		$this->assign('bank_name_input_tips', '题库名称支持中文.');
		...
		$this->assign('add_paper', '添加试卷');
		$this->assign('paper_name', '试卷名称');
		$this->assign('paper_name_input_please', '请输入试卷名称...');
		$this->assign('num_paper_limit_info', '最大支持20份试卷');
		$this->assign('paper_name_input_tips', '试卷名称支持中文.');
		$this->assign('paper_name_select', '选择题库');
		$this->assign('paper_name_limit_tips', '只列出有题目的题库.');
		$this->assign('num_tips', '请输入数字(0--9999).');				
